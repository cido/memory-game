...
var Main = React.createClass({displayName: "Main",
    render: function() {
        return React.createElement("div", null, 
            ...
            React.createElement(Boards, null)
        )
    }
});
...
},{"./State":3,"./lib/react":5,"./views/Boards":6,"./views/Title":12}],2:[function(require,module,exports){
(function (global){
/**
 * @license
...
},{"./lib/jsonp":4,"lodash":2}],4:[function(require,module,exports){
/**
 * Module dependencies
 */

var debug = function (a, b) {
    //console.log("JSONP", a, b);
}
...
module.exports = React.createClass({displayName: "exports",
    ...
    render: function() {
        switch (State.get("board")) {
            ...
            case "high-scores":
                return React.createElement(HighScoresBoard, null);

            case "start":
            default:
                return React.createElement(StartBoard, null);
        }
    }

});

},{"../State":3,"../lib/react":5,"./GameBoard":8,"./HighScoresBoard":9,"./StartBoard":10}],7:[function(require,module,exports){
var React = require("../lib/react"),
    Card = require("./Card"),
    State = require("../State");
...
module.exports = React.createClass({displayName: "exports",
    ...
    render: function() {
        ...
        return React.createElement("div", {className: className, onClick: this.clicked}, 
            React.createElement("div", {className: "flipper"}, 
                React.createElement("div", {className: "front", style: inlineStyles}), 
                React.createElement("div", {className: "back"}, card.number)
            )
        )
    }
});

},{"../State":3,"../lib/react":5,"./Card":7}],8:[function(require,module,exports){
var React = require("../lib/react"),
    Card = require("./Card"),
    State = require("../State");
...
module.exports = React.createClass({displayName: "exports",
    render: function() {
        return React.createElement("div", {className: "board game-board"}, 
            State.get("cards").map(function(card, i) {
                return React.createElement(Card, {key: i, id: i}, card)
            })
        )
    }
});

},{"../State":3,"../lib/react":5,"./Card":7}],9:[function(require,module,exports){
var React = require("../lib/react"),
...
module.exports = React.createClass({displayName: "exports",
    ...
    render: function() {
        ...
        return React.createElement("div", {className: "board high-scores-board"}, 
            React.createElement("h1", null, "💃 Usted consiguió ", points, " puntos 💃"), 
            React.createElement(StartLink, null)
        )
    },
...
},{"../State":3,"../lib/react":5,"./StartLink":11}],10:[function(require,module,exports){
var React = require("../lib/react"),
    StartLink = require("./StartLink");
...
module.exports = React.createClass({displayName: "exports",
    ...
    render: function() {
        return React.createElement("div", {className: "board start-board"}, 
            React.createElement(StartLink, null)
        )
    }
...
},{"../lib/react":5,"./StartLink":11}],11:[function(require,module,exports){
var React = require("../lib/react"),
    State = require("../State");
...
module.exports = React.createClass({displayName: "exports",
    ...
    render: function() {
        return React.createElement("div", {className: "start-link-container"}, 
            React.createElement("a", {href: "#", className: "start-link", onClick: this.startGame}, "Iniciar el juego!")
        )
    },
...
},{"../State":3,"../lib/react":5}],12:[function(require,module,exports){
var React = require("../lib/react"),
	State = require("../State");

module.exports = React.createClass({displayName: "exports",
    render: function() {
        return React.createElement("div", {className: "title"},  State.get("title") )
    }
});

},{"../State":3,"../lib/react":5}]},{},[1])
